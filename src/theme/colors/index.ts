...
export const transparent = ({theme}: {theme: DefaultTheme}) => theme.colors.transparent;
...
export const slateBlueGray = ({theme}: {theme: DefaultTheme}) => theme.colors.slateBlueGray;
export const slateGray = ({theme}: {theme: DefaultTheme}) => theme.colors.slateGray;
export const midnightNavy = ({theme}: {theme: DefaultTheme}) => theme.colors.midnightNavy;
export const nightSteelBlue = ({theme}: {theme: DefaultTheme}) => theme.colors.nightSteelBlue;
export const darkMidnightNavy = ({theme}: {theme: DefaultTheme}) => theme.colors.darkMidnightNavy;
export const deepCharcoal = ({theme}: {theme: DefaultTheme}) => theme.colors.deepCharcoal;
